...
class helpCommand extends BaseCommand {
  ...
  async execute (msg, args, prefix) {
    ...
    if (args[0]) {
      ...
      const command = this.client.CommandManager.commands[args[0]]
          || this.client.CommandManager.commands[this.client.CommandManager.commands.aliases[args[0]]];
      if (!command) {
  ...
  assemble (prefix) {
    const organised = {};
    const commands = Object.values(this.client.CommandManager.commands);
    ...
    const groups = Object.values(organised);
